...
#define BT_CMD_TASK_STACK_SIZE 4096  // Aumentado para evitar overflow
...
void bluetooth_control_init(void)
{
    ...
    BaseType_t task_ok = xTaskCreate(bt_cmd_task, "bt_cmd_task", BT_CMD_TASK_STACK_SIZE, NULL, BT_CMD_TASK_PRIORITY, NULL);
